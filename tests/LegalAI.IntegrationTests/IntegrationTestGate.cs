...
{
    private const string RunFlag = "LEGALAI_RUN_INTEGRATION";
    ...
    {
        var modelPath = Environment.GetEnvironmentVariable("LEGALAI_ONNX_MODEL_PATH");
    ...
    {
        var host = Environment.GetEnvironmentVariable("LEGALAI_QDRANT_HOST") ?? "127.0.0.1";
        var portValue = Environment.GetEnvironmentVariable("LEGALAI_QDRANT_PORT");
