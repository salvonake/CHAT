...
public sealed class AesGcmEncryptionServiceTests
{
    ...
    private AesGcmEncryptionService CreateEnabled(string passphrase = "TestPoseidon!Passphrase123")
    ...
    {
        var svc = CreateEnabled();
        var plaintext = Encoding.UTF8.GetBytes("Ø¨Ø³Ù… Ø§Ù„Ù„Ù‡ Ø§Ù„Ø±Ø­Ù…Ù† Ø§Ù„Ø±Ø­ÙŠÙ… â€” Ù‚Ø§Ù†ÙˆÙ† Ø§Ù„Ø¹Ù…Ù„ Ø§Ù„Ù…Ø§Ø¯Ø© 77");
    ...
    public void Decrypt_WrongPurpose_Throws()
    {
        ...
        // Different purpose = different derived key â†’ authentication failure
    ...
    {
        var svc = CreateEnabled();
        var original = "Ù†Øµ Ù‚Ø§Ù†ÙˆÙ†ÙŠ Ø³Ø±ÙŠ â€” Ø§Ù„Ù…Ø§Ø¯Ø© 45 Ù…Ù† Ù‚Ø§Ù†ÙˆÙ† Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª Ø§Ù„Ø¬Ø²Ø§Ø¦ÙŠØ©";
    ...
    {
        var svc = CreateEnabled();
        var arabic = "Ø¨ÙØ³Ù’Ù…Ù Ø§Ù„Ù„ÙŽÙ‘Ù‡Ù Ø§Ù„Ø±ÙŽÙ‘Ø­Ù’Ù…ÙŽÙ†Ù Ø§Ù„Ø±ÙŽÙ‘Ø­ÙÙŠÙ…Ù ï·½ â€” Ø§Ù„Ù…Ø§Ø¯Ø© Ù¤Ù¥";
