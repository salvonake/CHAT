...
public sealed class LegalQueryAnalyzerTests
{
    ...
    [Fact]
    public void QueryType_ArticleReference_Madda_Detected()
    {
    ...
    public void DetectedArticle_WithTaMarbuta_ExtractsNumber(string query)
    {
        _analyzer.Analyze(query).DetectedArticle.Should().NotBeNull();
    }
    ...
    [Fact]
    public void DetectedCaseNumber_WithTaMarbuta_ExtractsNumber()
    {
        _analyzer.Analyze("القضية رقم 2024/1234").DetectedCaseNumber.Should().Be("2024/1234");
    }
    ...
    [Fact]
    public void DetectedCourt_WithTaMarbuta_ExtractsCourt()
    {
        _analyzer.Analyze("محكمة النقض").DetectedCourt.Should().Be("النقض");
    }
