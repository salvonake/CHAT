...
namespace Poseidon.Ingestion.Chunking;
...
public sealed partial class LegalDocumentChunker : IDomainChunker
{
    ...
    [GeneratedRegex(@"(?:\u0627\u0644\u0645\u0627\u062f[\u0629\u0647]|\u0627\u0644\u0645\u0627\u062f\u0651[\u0629\u0647]|\u0645\u0627\u062f[\u0629\u0647]|\u0645\u0627\u062f\u0651[\u0629\u0647])\s*(?:\u0631\u0642\u0645\s*)?([\d\u0660-\u0669]+)", RegexOptions.Compiled)]
    ...
    [GeneratedRegex(@"(?:\u0627\u0644\u0642\u0636\u064a[\u0629\u0647]|\u0642\u0636\u064a[\u0629\u0647]|\u0627\u0644\u062f\u0639\u0648\u0649|\u062f\u0639\u0648\u0649)\s*(?:\u0631\u0642\u0645\s*)?([\d\u0660-\u0669/\-]+)", RegexOptions.Compiled)]
    private static partial Regex CaseNumberPattern();

    [GeneratedRegex(@"(?:\u0645\u062d\u0643\u0645[\u0629\u0647]|\u0627\u0644\u0645\u062d\u0643\u0645[\u0629\u0647])\s+([\u0600-\u06FF\s]+?)(?:\s*[-\u2013\u2014]|\s*$)", RegexOptions.Compiled)]
    ...
    {
        // Rough approximation: Arabic words are about 1.5 tokens on average.
