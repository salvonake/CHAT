...
public partial class SetupWizardViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string _stepTitle = "Welcome to Poseidon";
    ...
    {
        var llmPath = ModelPathResolver.ResolveLlmPath(_config, _paths);
    ...
    private void PickModelsFolder()
    {
        ...
        var llmPath = ModelPathResolver.KnownLlmModelFileNames
    ...
    {
        var configPath = string.IsNullOrWhiteSpace(_paths.UserConfigPath)
