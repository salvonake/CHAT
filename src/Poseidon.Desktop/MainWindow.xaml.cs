...
public partial class MainWindow : Window
{
    ...
    private readonly DiagnosticWindowService? _diagnosticWindowService;
    ...
    public MainWindow(
        ...
        DiagnosticWindowService? diagnosticWindowService = null)
    {
        _paths = paths;
        _configuration = configuration;
        _logger = logger;
        _diagnosticWindowService = diagnosticWindowService;
    ...
    private void OnMainWindowPreviewKeyDown(object sender, KeyEventArgs e)
    {
        ...
        {
            _diagnosticWindowService?.ShowOrActivate();
            e.Handled = true;
        }
    }
    ...
    private void InitializeTrayIcon()
    {
        ...
        var openItem = new Forms.ToolStripMenuItem("Open Poseidon", null, (_, _) => RestoreAndActivateWindow());
    ...
    private Icon LoadTrayIcon()
    {
        try
        {
            var iconPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "Poseidon.ico");
    ...
    private void HideToTray()
    {
        ...
        {
            ShowTrayBalloon(
                "Poseidon is running in the background",
