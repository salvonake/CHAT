...
{
	options.ServiceName = "LegalAI WorkerService";
});
...
services.AddHostedService<WorkerStartupInitializationService>();
	...
	InstanceRuntimeOptions instance)
{
	...
	else
	{
		...
		{
			collectionName = $"legalai_{instance.SanitizedInstanceId}_chunks";
		}
...
internal sealed class WorkerStartupInitializationService : IHostedService
{
	private readonly IVectorStore _vectorStore;
	private readonly IAuditService _auditService;
	private readonly InstanceRuntimeOptions _instance;
	private readonly ILogger<WorkerStartupInitializationService> _logger;

	public WorkerStartupInitializationService(
		IVectorStore vectorStore,
		IAuditService auditService,
		InstanceRuntimeOptions instance,
		ILogger<WorkerStartupInitializationService> logger)
	{
	...
	public async Task StartAsync(CancellationToken cancellationToken)
	{
		...
		_logger.LogInformation(
			"Worker startup initialization complete for {InstanceName} ({InstanceId})",
