namespace Poseidon.Domain.ValueObjects;
...
public sealed class RetrievalConfig
{
    ...
    /// <summary>Multiplier for rerank candidates (TopK Ã— Multiplier).</summary>
    ...
    /// <summary>Enable strict evidence mode â€” every claim must be cited.</summary>
