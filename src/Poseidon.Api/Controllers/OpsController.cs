...
public sealed class OpsController : ControllerBase
{
    ...
    /// <summary>
    /// System health check â€” verifies Qdrant, Ollama, and audit chain integrity.
    /// </summary>
    [HttpGet("health")]
    public async Task<IActionResult> Health(CancellationToken ct)
    {
        ...
        {
            Status = _text.T("HealthStatusHealthy", language),
        ...
        {
            Status = _text.T("HealthStatusUnhealthy", language),
