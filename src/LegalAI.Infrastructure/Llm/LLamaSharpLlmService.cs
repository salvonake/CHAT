...
namespace LegalAI.Infrastructure.Llm;
...
///
/// This is an ADDITIONAL implementation — OllamaLlmService remains available as an alternative.
///
/// NuGet dependencies:
///   LLamaSharp 0.19.*
...
public sealed class LLamaSharpLlmService : ILlmService, IDisposable
{
    ...
    // LLamaSharp objects — lazily initialized
